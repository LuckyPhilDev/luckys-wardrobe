...
LuckysWardrobe.Strings = {
    ...
    welcome = {
        ...
        body = "Nothing was carried over from anything older, so there is functionality it does not have yet. More of it lands with every release.",
        ...
        linkLabel = "Discord",
        discordURL = "https://discord.gg/87HRHcAYP",
