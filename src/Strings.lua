...
LuckysWardrobe.Strings = {
    ...
    extraSets = {
        ...
        report = {
            notStarted = "Extra Sets discovery has not run yet. Open Collections, Appearances first.",
            building = "Extra Sets discovery is still running. Try again in a moment.",
            header = "Extra Sets on client %s: %d set(s) listed, %d candidate(s) left out.",
            usableLine = "  usable by this character: %d",
            groupLine = "  %s: %d",
            hint = "Use /wardrobe extrasets full to list everything, or /wardrobe extrasets find <name> to look one up.",
            findHeader = "Extra Sets matching \"%s\":",
            findNone = "Nothing scanned on this client is named like \"%s\", so the scan never saw it.",
            ...
            sweepNone = "No set named like \"%s\" exists on this client below TransmogSet %d or ItemSet %d.",
            includedHeader = "Listed sets (%d):",
            recordLine = "  %s %d: %s (%d pieces)",
            rejectedHeader = "Candidates left out (%d):",
            rejectionLine = "  %s %s: %s",
            unnamed = "(no name)",
        },
    },
