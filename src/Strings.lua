...
LuckysWardrobe.Strings = {
    ...
    extraSets = {
        ...
        report = {
            ...
            groupLine = "  %s: %d",
            hint = "Use /wardrobe extrasets full to list everything, /wardrobe extrasets find <name> to look one up, /wardrobe extrasets looks <name> to compare a set's appearance IDs with the Sets tab's, or /wardrobe extrasets pieces to read the selected set piece by piece.",
