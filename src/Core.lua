...
local function initialize()
    ...
    LuckysWardrobe.PreviewSlots:Init(LuckysWardrobeDB)
    LuckysWardrobe.WardrobeKeys:Init()
    LuckysWardrobe.SetSearch:Init()
    ...
    LuckysWardrobe.DressingRoom:Init(LuckysWardrobeDB)
