...
- **Set names at the transmogrifier**: every set card at the transmog NPC carries its name along the bottom, on the Sets, Custom Sets and Extra Sets tabs alike.
