...
- **Track a whole set at once, or one piece of it**: shift-click a set in the Sets collection to track every appearance you are still missing from it, or open the set and shift-click one of its pieces to track just that one.
