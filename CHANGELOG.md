...
- **Conflict warning**: a warning at login if Better Wardrobe is still running or the old Lucky's Better Wardrobe folder is still there, with what to do about each.
