...
- **Set names on the cards**: Every set card at the transmog NPC carries its name along the bottom, on the Sets, Custom Sets and Extra Sets tabs alike, so you can tell one little model from another without hovering each in turn.
