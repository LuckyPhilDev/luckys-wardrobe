...
- **See what you are hunting**: Open a set and the pieces you are tracking carry a crosshair, in the Sets tab and the Extra Sets tab alike, so a set says what you are still out after.
