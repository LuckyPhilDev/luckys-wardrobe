...
- **Search by expansion or side**: Type an expansion into any set list's search box, as its full name or a short form like tww, df or bfa, and the list is cut to that expansion. Add pvp or pve, as in "tww pvp", to narrow it again. Works on the Sets, Extra Sets and Custom tabs, in Appearances and at the transmog NPC alike.
