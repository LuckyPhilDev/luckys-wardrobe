...
- **Only the sets you can wear**: The Sets tab at the transmog NPC offers a set for every class, most of it armour your character can never put on. Those are hidden, so what is left is what you could actually apply. Turn it off in settings to browse them all again.
